...
The output includes a clean terminal summary table and an auto-generated `report.txt` file for offline reference. The script uses ANSI colors sparingly to keep the interface readable without looking automated or noisy.
